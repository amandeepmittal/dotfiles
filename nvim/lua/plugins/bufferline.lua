  ...
  config = function()
    require("bufferline").setup({
      ...
      highlights = {
        ...
        buffer_selected = { fg = "#f0f3f6", bg = "#1a3858", bold = true, italic = false },
        close_button = { fg = "#7d8590", bg = "#0a0c10" },
        close_button_selected = { bg = "#1a3858" },
        modified = { bg = "#0a0c10" },
        modified_selected = { bg = "#1a3858" },
        indicator_selected = { fg = "#71b7ff", bg = "#1a3858" },  -- blue edge on the active tab
